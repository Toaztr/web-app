...
import { FundingFees, FundingResults, FundingParameters, OldPropertyExpenses, HouseConstructionExpensesFees } from 'src/app/_api';
import { Summary } from '../../../summary';

@Component({
  selector: 'app-oldproperty-summary',
  templateUrl: './oldproperty-summary.component.html',
  styleUrls: ['../funding-summary.component.scss']
})
export class OldpropertySummaryComponent extends Summary implements OnInit {
