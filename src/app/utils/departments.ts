export const departments = [
    ...
    {name: 'Seine-St-Denis', number: '93'},
    {name: 'Val-de-Marne', number: '94'},
    {name: 'Val-D\'Oise', number: '95'},
    {name: 'Guadeloupe', number: '971'},
    {name: 'Martinique', number: '972'},
    {name: 'Guyane', number: '973'},
    {name: 'La Réunion', number: '974'},
    {name: 'Mayotte', number: '976'},
  ];

export function getDepartmentName(departmentNumber: string): string {
  return departments.find(d => d.number === departmentNumber).name;
}
