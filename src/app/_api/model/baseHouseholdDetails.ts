...
/**
 * Informations relatives au ménage.
 */
export interface BaseHouseholdDetails { 
    type: BaseHouseholdDetails.TypeEnum;
    persons?: Array<BasePerson>;
    finance?: BaseFinanceDetails;
}
export namespace BaseHouseholdDetails {
