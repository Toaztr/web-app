 ...
 */
export type SubscriptionRequestLogMethod = 'POST' | 'PUT' | 'DELETE';

export const SubscriptionRequestLogMethod = {
    Post: 'POST' as SubscriptionRequestLogMethod,
    Put: 'PUT' as SubscriptionRequestLogMethod,
    Delete: 'DELETE' as SubscriptionRequestLogMethod
};
