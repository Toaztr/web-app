...
/**
 * Paramètres permettant de générer une facture à destination d\'un partenaire.
 */
export interface PartnerBillingParameters { 
    /**
     * Type de paramètres de faturation.
     */
    type: PartnerBillingParameters.TypeEnum;
    funding_results: FundingResults;
    _case: Case;
    partner_from: Partner;
    partner_to: Partner;
}
export namespace PartnerBillingParameters {
    export type TypeEnum = 'PARTNER_BILLING_PARAMETERS';
    export const TypeEnum = {
        PartnerBillingParameters: 'PARTNER_BILLING_PARAMETERS' as TypeEnum
    };
}
