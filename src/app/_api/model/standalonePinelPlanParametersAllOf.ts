...
export interface StandalonePinelPlanParametersAllOf { 
    /**
     * Type du jeu de paramètres.
     */
    type: StandalonePinelPlanParametersAllOf.TypeEnum;
    /**
     * Nom des paramètres
     */
    name?: string;
}
export namespace StandalonePinelPlanParametersAllOf {
