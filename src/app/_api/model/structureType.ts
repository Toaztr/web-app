 ...
 * Type de structure.
 */
export type StructureType = 'SCI' | 'COMPANY' | 'ASSOCIATION' | 'POLITICAL_PARTY' | 'LOCAL_AUTHORITIES';

export const StructureType = {
    Sci: 'SCI' as StructureType,
    Company: 'COMPANY' as StructureType,
    Association: 'ASSOCIATION' as StructureType,
    PoliticalParty: 'POLITICAL_PARTY' as StructureType,
    LocalAuthorities: 'LOCAL_AUTHORITIES' as StructureType
};
