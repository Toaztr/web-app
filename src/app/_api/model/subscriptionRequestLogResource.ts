 ...
 */
import { SubscriptionRequestLog } from './subscriptionRequestLog';
import { SubscriptionRequestLogResourceAllOf } from './subscriptionRequestLogResourceAllOf';
import { Resource } from './resource';
import { ResourceMeta } from './resourceMeta';


/**
 * Représente la trace d\'une requête
 */
export interface SubscriptionRequestLogResource { 
    /**
     * ID unique de la ressource
     */
    readonly id?: string;
    attributes?: SubscriptionRequestLog;
    meta?: ResourceMeta;
}
