...
/**
 * Valeur monétaire et sa pondération.
 */
export interface WeightedFigure { 
    /**
     * Chiffre.
     */
    figure: number;
    /**
     * Pondération en pourcentage: 30 pour 30%. C\'est à dire qu\'un coefficient de 0.3 sera appliqué à ce chiffre.
     */
    weight?: number;
}
