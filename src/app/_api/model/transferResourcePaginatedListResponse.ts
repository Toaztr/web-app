...
import { TransferResourcePaginatedListResponseAllOf } from './transferResourcePaginatedListResponseAllOf';
import { PaginatedResponseLinks } from './paginatedResponseLinks';


export interface TransferResourcePaginatedListResponse { 
