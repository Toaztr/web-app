...
/**
 * Valeur monétaire positive et sa pondération.
 */
export interface WeightedPositiveFigure { 
    /**
     * Chiffre.
     */
    figure: number;
    /**
     * Pondération en pourcentage: 30 pour 30%. C\'est à dire qu\'un coefficient de 0.3 sera applicqué à ce chiffre.
     */
    weight?: number;
}
