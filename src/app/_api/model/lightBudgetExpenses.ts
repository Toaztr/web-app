...
export interface LightBudgetExpenses { 
    /**
     * Montant des éventuelles autres dépenses à diminuer du budget. Ces dépenses seront exclus du calcul des frais de notaire.
     */
