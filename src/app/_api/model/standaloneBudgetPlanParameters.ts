...
import { StandaloneBudgetPlanParametersAllOf } from './standaloneBudgetPlanParametersAllOf';


/**
 * Paramètres d\'un calcul de budget, conservés isolément.
 */
export interface StandaloneBudgetPlanParameters { 
    /**
     ...
     */
    type: StandaloneBudgetPlanParameters.TypeEnum;
    /**
     * Nom des paramètres
     */
    name?: string;
}
export namespace StandaloneBudgetPlanParameters {
