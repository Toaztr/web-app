 ...
 */
import { LMNPHouseConstructionExpenses } from './lMNPHouseConstructionExpenses';
import { CallsForFunds } from './callsForFunds';


export interface LMNPHouseConstruction { 
    type: LMNPHouseConstruction.TypeEnum;
    calls_for_funds?: CallsForFunds;
    expenses?: LMNPHouseConstructionExpenses;
}
export namespace LMNPHouseConstruction {
