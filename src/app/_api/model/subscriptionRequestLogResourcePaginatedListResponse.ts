 ...
 */
import { SubscriptionRequestLogResourcePaginatedListResponseAllOf } from './subscriptionRequestLogResourcePaginatedListResponseAllOf';
import { PaginatedResponse } from './paginatedResponse';
import { PaginatedResponseMeta } from './paginatedResponseMeta';
import { SubscriptionRequestLogResource } from './subscriptionRequestLogResource';
import { PaginatedResponseLinks } from './paginatedResponseLinks';


export interface SubscriptionRequestLogResourcePaginatedListResponse { 
    meta?: PaginatedResponseMeta;
    links?: PaginatedResponseLinks;
    data?: Array<SubscriptionRequestLogResource>;
}
