 ...
 * État du projet.
 */
export type ProjectState = 'BEFORE_COMPROMIS' | 'COMPROMIS_SIGNED' | 'SIGNED' | 'CANCELED';

export const ProjectState = {
    BeforeCompromis: 'BEFORE_COMPROMIS' as ProjectState,
    CompromisSigned: 'COMPROMIS_SIGNED' as ProjectState,
    Signed: 'SIGNED' as ProjectState,
    Canceled: 'CANCELED' as ProjectState
};
