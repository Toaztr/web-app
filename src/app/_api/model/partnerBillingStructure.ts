 ...
 */
import { PartnerBillingTiersPerLoan } from './partnerBillingTiersPerLoan';


/**
 * Structure de facturation du partenaire.
 */
export interface PartnerBillingStructure { 
    partner_billing: Array<PartnerBillingTiersPerLoan>;
    /**
     * Montant maximum du commissionnement de ce partenaire, si un maximum existe.
     */
    limit?: number;
}
